(() => {
    ...
    let btnPass = document.querySelector(".js-btn-password"), inputPass = document.querySelector(".js-password-input");
    btnPass.onclick = function() {
        if ("password" === inputPass.getAttribute("type")) inputPass.setAttribute("type", "text"); else inputPass.setAttribute("type", "password");
    };
    window["FLS"] = true;
    isWebp();
    menuInit();
